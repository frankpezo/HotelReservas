...
<head>
        ...
        <!--1. Creamos una ruta para que se nos cargué el estilo de la plantilla--->
			...
			<div class="navbar-area">
				...
				<div class="mobile-nav">
					<a href="<?php  echo RUTA_PRINCIPAL; ?>" class="logo">
						<img src="<?php  echo RUTA_PRINCIPAL . 'assets'; ?>/img/logo.png" alt="Logo" width=50 height=50>
					</a>
				</div>
					...
					<nav class="navbar navbar-expand-md navbar-light">
						<div class="container">
							<a class="navbar-brand" href="<?php  echo RUTA_PRINCIPAL; ?>">
								<img src="<?php  echo RUTA_PRINCIPAL . 'assets'; ?>/img/logo.png" alt="Logo" width=200 height=200>
							</a>
